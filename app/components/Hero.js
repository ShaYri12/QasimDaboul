...
const Hero = () => {
  return (
    <div
      id="home"
      className="flex md:flex-row flex-col xl:gap-[50px] lg:gap-[40px] gap-[30px] pt-[48px] lg:pt-[160px] pb-[60px] bg-white max-w-[1280px] mx-auto"
    >
      <div className="md:w-1/2 w-full flex flex-col justify-end">
        <h1 className="font-abhaya 2xl:text-[5.4vw] lg:text-[8vw] md:text-[8.7vw] sm:text-[9vw] text-[50px] font-[700] text-black 2xl:leading-[6vw] xl:leading-[6vw] lg:leading-[8vw] md:leading-[8.7vw] leading-[50px]">
      ...
      <div className="md:w-1/2 w-full md:h-[570px] h-[100vw] mt-6 md:mt-0 flex justify-center relative">
