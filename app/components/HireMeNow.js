      ...
      <div className="pt-10 max-w-[1280px] mx-auto">
        <div className="w-full bg-[#202020] sm:rounded-se-[100px] flex xl:items-center xl:justify-end relative flex-col xl:flex-row">
          ...
          <div className="xl:pr-[80px] flex xl:items-start gap-5 flex-col py-[30px] sm:py-[50px] justify-end px-4 xl:px-0">
            <h1 className="text-[28px] sm:text-[40px] md:text-[60px] text-white font-semibold max-w-[700px]">
              Creativity & Functionality in Every Design! Get Now
            </h1>
            <button className="text-[#FFFAF3] w-[150px] sm:w-[200px] h-[40px] sm:h-[50px] text-[15px] sm:text-[20px] rounded-lg border border-[#FFFAF3]">
              HIRE ME NOW
            </button>
          </div>
        </div>
