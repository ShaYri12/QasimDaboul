    ...
    <section className="bg-color-bg">
      <div className="md:py-[160px] py-[60px] max-w-[1280px] mx-auto">
        ...
        <div id="about" className="mb-[50px] pt-[20px]">
          <h2 className="text-[22.46px] leading-[26.95px] font-[400] uppercase text-[#6D7D7D] tracking-[6px]">
            About
          </h2>
          <h1 className="sm:text-[56px] text-[40px] sm:leading-[67.37px] leading-[50px] font-[600] text-primaryColor mb-[23px] mt-[6px]">
            The Best Interior Design Provider
          </h1>
          <p className="text-secondaryColor text-[20px] font-[400] leading-[30px]">
