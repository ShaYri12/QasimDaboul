        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-16 sm:gap-20 md:gap-4 lg:gap-14 md:py-12 xl:ps-[100px] lg:ps-[50px] md:ps-4">
          ...
          <div className="md:w-1/2">
            <div className="md:mb-[100px] mb-[50px]">
              <h3 className="lg:text-[36px] md:text-[30px] sm:text-[26px] text-[23px] font-[600] text-primaryColor leading-[48px]">
                Step 01: Understanding
              </h3>
              <p className="text-secondaryColor lg:text-[20px] sm:text-[18px] text-[17px] font-[400] leading-[30px] md:mt-[20px] mt-[10px]">
